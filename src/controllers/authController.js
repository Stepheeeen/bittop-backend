...
export const signup = async (req, res) => {
    try {
        ...
        <div style="font-family: Arial, sans-serif; color: #222; background-color: #f9f9f9; padding: 20px; border-radius: 8px;">
            ...
            <p>Hi there,</p>
            <p>We’re thrilled to have you onboard. Your BITTOP account has been created and is ready to use.</p>
            ...
            <p style="margin-top: 20px;">
                Welcome to the future of digital finance.<br><b>The BITTOP Team</b>
            </p>
        </div>
        `
